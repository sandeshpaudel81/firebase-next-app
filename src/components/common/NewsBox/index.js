...
const NewsBox = ({news}) => {
    const {metaImage, title, content, posted_at, id, metaId} = news
    return (
      <div className='col-span-4 md:col-span-1 shadow-lg h-72 relative group overflow-hidden'>
          ...
          <div className='overflow-hidden z-10'>
              <img src={metaImage} alt={title} className='w-full h-[200px] object-cover object-center group-hover:scale-[1.1] group-hover:blur-[1px] duration-300'/>
          </div>
