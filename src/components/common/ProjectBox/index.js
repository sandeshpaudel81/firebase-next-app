        ...
        <Link href={`/projects/${project.id}`}>
          <div className='grid grid-cols-5 bg-slate-300 shadow-sm shadow-white hover:shadow-md hover:shadow-white duration-500 rounded-lg overflow-hidden group'>
              <div className='col-span-5 md:col-span-2 overflow-hidden'>
                  <img src={project.thumbnailImageUrl} alt={project.title} className="w-full h-[250px] md:h-[200px] object-cover object-center"/>
              </div>
              <div className='col-span-5 md:col-span-3 relative p-5'>
                  ...
                  <p className='h-24 overflow-hidden'>{project.objectives}</p>
